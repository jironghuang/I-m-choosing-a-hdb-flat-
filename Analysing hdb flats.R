...
#Multiply all the attributes to get the score
sel_units$score = 5* sel_units$no_afternn_sun..5. + 5* sel_units$awayfr_mainrd..5. + 
...
library(dplyr)
sel_units = arrange(sel_units, desc(score)) 

write.csv(sel_units,"ranked units.csv")
